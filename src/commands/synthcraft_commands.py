...
class SynthCraftCommands(commands.Cog):
    ...
    @synthcraft_group.command(name="activate")
    @owner_only()
    ...
    async def activate(self, interaction: discord.Interaction, license_id: int):
        """Activate a SynthCraft license (set to ACTIVE/unlimited) by license ID."""
        await interaction.response.defer(ephemeral=True)
    ...
    # =========================================================================
    # /synthcraft deactivate
    # =========================================================================

    @synthcraft_group.command(name="deactivate")
    @owner_only()
    ...
    async def deactivate(self, interaction: discord.Interaction, license_id: int):
        """Deactivate a SynthCraft license (set to EXPIRED) by license ID."""
        await interaction.response.defer(ephemeral=True)
